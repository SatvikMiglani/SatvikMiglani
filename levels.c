...
void GenerationEasy(char array[3][3],int turn)
{
	srand(time(0));
...
void GenerationHard(char array[3][3],int turn)
{
	srand(time(0));
	int randomRow, randomColumn,randomBlock;
	if(turn == 1)
	...
	else if(turn != 1)
	{
		...
		else if((array[1][0]=='O')&&(array[0][0]=='O')&&(array[2][0]!='X')&&(array[2][0]!='O'))
		{
			array[2][0]='O';
		}
		...
		else if((array[1][1]=='O')&&(array[0][0]=='O')&&(array[2][2]!='X')&&(array[2][2]!='O'))
		{
			array[2][2]='O';
		}
		...
		else if((array[1][2]=='O')&&(array[1][1]=='O')&&(array[1][0]!='X')&&(array[1][0]!='O'))
		{
			array[1][0]='O';
		}
		...
		else if((array[1][2]=='O')&&(array[0][2]=='O')&&(array[2][2]!='X')&&(array[2][2]!='O'))
		{
			array[2][2]='O';
		}
		...
		else if((array[2][0]=='O')&&(array[1][0]=='O')&&(array[0][0]!='X')&&(array[0][0]!='O'))
		{
			array[0][0]='O';
		}
		...
		else if((array[0][0]=='X')&&(array[0][1]=='X')&&(array[0][2]!='X')&&(array[0][2]!='O'))
		{
			array[0][2]='O';
		}
		...
		else if((array[0][2]=='X')&&(array[0][1]=='X')&&(array[0][0]!='X')&&(array[0][0]!='O'))
		{
			array[0][0]='O';
		}
		else if((array[0][2]=='X')&&(array[0][0]=='X')&&(array[0][1]!='X')&&(array[0][1]!='O'))
		{
			array[0][1]='O';
		}
		...
		else if((array[1][0]=='X')&&(array[0][0]=='X')&&(array[2][0]!='X')&&(array[2][0]!='O'))
		{
			array[2][0]='O';
		}
		else if((array[1][0]=='X')&&(array[2][0]=='X')&&(array[0][0]!='X')&&(array[0][0]!='O'))
		{
			array[0][0]='O';
		}
		...
		else if((array[1][1]=='X')&&(array[0][0]=='X')&&(array[2][2]!='X')&&(array[2][2]!='O'))
		{
			array[2][2]='O';
		}
		else if((array[1][1]=='X')&&(array[2][2]=='X')&&(array[0][0]!='X')&&(array[0][0]!='O'))
		{
			array[0][0]='O';
		}
		else if((array[1][1]=='X')&&(array[2][1]=='X')&&(array[0][1]!='X')&&(array[0][1]!='O'))
		{
			array[0][1]='O';
		}
		else if((array[1][1]=='X')&&(array[0][1]=='X')&&(array[2][1]!='X')&&(array[2][1]!='O'))
		{
			array[2][1]='O';
		}
		else if((array[1][1]=='X')&&(array[0][2]=='X')&&(array[2][0]!='X')&&(array[2][0]!='O'))
		{
			array[2][0]='O';
		}
		else if((array[1][1]=='X')&&(array[2][0]=='X')&&(array[0][2]!='X')&&(array[0][2]!='O'))
		{
			array[0][2]='O';
		}
		else if((array[1][1]=='X')&&(array[1][0]=='X')&&(array[1][2]!='X')&&(array[1][2]!='O'))
		{
			array[1][2]='O';
		}
		else if((array[1][1]=='X')&&(array[1][2]=='X')&&(array[1][0]!='X')&&(array[1][0]!='O'))
		{
			array[1][0]='O';
		}
		else if((array[1][2]=='X')&&(array[1][1]=='X')&&(array[1][0]!='X')&&(array[1][0]!='O'))
		{
			array[1][0]='O';
		}
		else if((array[1][2]=='X')&&(array[1][0]=='X')&&(array[1][1]!='X')&&(array[1][1]!='O'))
		{
			array[1][1]='O';
		}
		else if((array[1][2]=='X')&&(array[0][2]=='X')&&(array[2][2]!='X')&&(array[2][2]!='O'))
		{
			array[2][2]='O';
		}
		else if((array[1][2]=='X')&&(array[2][2]=='X')&&(array[0][2]!='X')&&(array[0][2]!='O'))
		{
			array[0][2]='O';
		}
		else if((array[2][0]=='X')&&(array[1][0]=='X')&&(array[0][0]!='X')&&(array[0][0]!='O'))
		{
			array[0][0]='O';
		}
		else if((array[2][0]=='X')&&(array[0][0]=='X')&&(array[1][0]!='X')&&(array[1][0]!='O'))
		{
			array[1][0]='O';
		}
		...
		else if((array[2][0]=='X')&&(array[1][1]=='X')&&(array[0][2]!='X')&&(array[0][2]!='O'))
		{
			array[0][2]='O';
		}
		else if((array[2][0]=='X')&&(array[0][2]=='X')&&(array[1][1]!='X')&&(array[1][1]!='O'))
		{
			array[1][1]='O';
		}
		else if((array[2][1]=='X')&&(array[2][0]=='X')&&(array[2][2]!='X')&&(array[2][2]!='O'))
		{
			array[2][2]='O';
		}
		else if((array[2][1]=='X')&&(array[2][2]=='X')&&(array[2][0]!='X')&&(array[2][0]!='O'))
		{
			array[2][0]='O';
		}
		else if((array[2][1]=='X')&&(array[1][1]=='X')&&(array[0][1]!='X')&&(array[0][1]!='O'))
		{
			array[0][1]='O';
		}
		else if((array[2][1]=='X')&&(array[0][1]=='X')&&(array[1][1]!='X')&&(array[1][1]!='O'))
		{
			array[1][1]='O';
		}
		else if((array[2][2]=='X')&&(array[2][1]=='X')&&(array[2][0]!='X')&&(array[2][0]!='O'))
		{
			array[2][0]='O';
		}
		else if((array[2][2]=='X')&&(array[2][0]=='X')&&(array[2][1]!='X')&&(array[2][1]!='O'))
		{
			array[2][1]='O';
		}
		else if((array[2][2]=='X')&&(array[1][1]=='X')&&(array[0][0]!='X')&&(array[0][0]!='O'))
		{
			array[0][0]='O';
		}
		else if((array[2][2]=='X')&&(array[0][0]=='X')&&(array[1][1]!='X')&&(array[1][1]!='O'))
		{
			array[1][1]='O';
		}
		else if((array[2][2]=='X')&&(array[1][2]=='X')&&(array[0][2]!='X')&&(array[0][2]!='O'))
		{
			array[0][2]='O';
		}
		else if((array[2][2]=='X')&&(array[0][2]=='X')&&(array[1][2]!='X')&&(array[1][2]!='O'))
		{
			array[1][2]='O';
		}
		else
...
int main()
{
	...
	if(levelchoice == 1)
	{
		while(condition != 1)
		{
			...
			sleep(2);
			GenerationEasy(PresentState,turn);
			turn++;
	...
	else if(levelchoice == 2)
	{
		while(condition != 1)
		{
			printf("Present turn computer:\n");
			sleep(2);
			GenerationHard(PresentState,turn);
			turn++;
			condition = ConditionCheck(PresentState,&winner);
			if((turn == 10)||(condition == 1))
			break;
