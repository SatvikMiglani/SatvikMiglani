...
(((array[0][0]=='O')&&(array[0][1]=='O')&&(array[0][2]=='O'))||((array[1][0]=='O')&&(array[1][1]=='O')&&(array[1][2]=='O'))||((array[2][0]=='O')&&(array[2][1]=='O')&&(array[2][2]=='O'))||((array[0][0]=='O')&&(array[1][0]=='O')&&(array[2][0]=='O'))||((array[0][1]=='O')&&(array[1][1]=='O')&&(array[2][1]=='O'))||((array[0][2]=='O')&&(array[1][2]=='O')&&(array[2][2]=='O'))||((array[0][0]=='O')&&(array[1][1]=='O')&&(array[2][2]=='O'))||((array[0][2]=='O')&&(array[1][1]=='O')&&(array[2][0]=='O')))
{
	*winner = 1;
	return 1;
}
